%%**************************************
%% Based on:
%% http://www.erlang.org/examples/small_examples/urlget.erl
%%
...
test(3) -> proxy("http://www.botspiritcompany.com/botlist/spring/botverse/text/botverse_light.html");
test(4) -> proxy("http://www.botspiritcompany.com/botlist/spring/pipes/botverse_pipes.html").
