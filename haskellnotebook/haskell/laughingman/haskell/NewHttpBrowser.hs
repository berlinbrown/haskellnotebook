-----------------------------------------------------------------------------
-- Modifications - Berlin Brown
-- 11/24/2007
-----------------------------------------------------------------------------
-- |
-- Module      :  NewHttpBrowser
...
--
-- Fixing cookie parser to not fail
-----------------------------------------------------------------------------
...
import qualified NewMD5 as MD5
import qualified NewBase64 as Base64
...
emptyCookieDetails :: [(String,String)]
emptyCookieDetails = [("None", "None")]

mkEmptyCookies :: [Cookie]
mkEmptyCookies = []
