...
#define DebugBrainGrow 1  // Editable
...
FILE* brain::startFunctional( long index )
{
	...
	// print the header, with index (agent number), neuron count, number of input neurons, number of synapses, timestep born, firstredneuron, lastredneuron, firstgreenneuron, lastgreeneuron, firstblueneuron, lastblueneuron
	fprintf( file, "brainFunction %ld %d %d %ld %d-%d %d-%d %d-%d\n", index, numneurons, numinputneurons, numsynapses, redneuron, lRindex, greenneuron, lGindex, blueneuron, lBindex );
...
// brain::Grow
//---------------------------------------------------------------------------
void brain::Grow( genome* g, long agentNumber, bool recordBrainAnatomy )
{
#ifdef DEBUGCHECK
