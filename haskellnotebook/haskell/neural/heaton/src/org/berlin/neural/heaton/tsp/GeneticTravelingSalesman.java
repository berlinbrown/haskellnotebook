 ...
 */
package org.berlin.neural.heaton.tsp;
 ...
 * 
 * GeneticTravelingSalesman: Attempt to solve the traveling salesman problem
...
public class GeneticTravelingSalesman extends JFrame implements Runnable, ComponentListener {
    ...
    public void componentShown(final ComponentEvent e) {
        ...
        for (int i = 0; i < GeneticTravelingSalesman.CITY_COUNT; i++) {
            this.cities[i] = new City((int) (Math.random() * width), (int) (Math.random() * height));
        }
    ...
    public void run() {
        ...
        while (countSame < 100) {
            ...
            this.status.setText("Generation " + this.generation + " Cost " + (int) thisCost + " Mutated " + nf.format(0) + "%");
        ...
        this.status.setText("Solution found after " + this.generation + " generations.");
    }
